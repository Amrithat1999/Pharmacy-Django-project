...
from ecom.forms import UploadFileForm
import easyocr
        ...
        if form.is_valid():
            ...
            for word in extracted_text:
                if word.isupper() and len(word) >= 4:
                    data.append(word)
            return render(request, 'ecom/image.html', {'extracted_text': data, 'products': products})
    else:
        form = UploadFileForm()
    return render(request, 'ecom/image.html', {'form': form, 'products': products})
